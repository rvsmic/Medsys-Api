...
class UserServiceTest {
    ...
    void testUserInfo() throws QueryException {
        when(queryDispatcher.getSecUserDetails(anyInt())).thenReturn(new SecUserDetails(0, "Shanera Yoshioka", new GregorianCalendar(2024, Calendar.MAY, 28, 13, 25).getTime(), "pesel", "gender", "phone_number", "address", "speciality", "username", "password", "profession"));
